...
onMounted(async () => {
  ...
  blurMapImage.value.src =
    "https://is1-ssl.mzstatic.com/image/thumb/Music211/v4/72/63/51/726351e7-2016-48f3-07f8-0891c9eb5e53/075679624161.jpg/316x316bb.webp";
});
</script>
  ...
  <div class="q-pa-lg plugin-base">
    ...
    <template v-if="currentSection === 'players'">
      ...
      <div class="component-title">
        &lt;cider-lcdplayer-glass <i>compact</i> /&gt;
      </div>
    ...
    <template v-if="mediaItems && currentSection === 'media-items'">
      ...
      <cider-media-item-slider title="Title" url="#" :items="mediaItems" />
      ...
      <cider-hero-item-scroller title="Title" :items="mediaItems" />
    ...
    <template v-if="currentSection === 'immersive'">
      ...
      <div class="component-title">&lt;cider-immersive-artwork /&gt;</div>
      <div class="simple-container">
      ...
      <div class="component-title">&lt;cider-artwork-blur-map /&gt;</div>
      <div class="simple-container">
